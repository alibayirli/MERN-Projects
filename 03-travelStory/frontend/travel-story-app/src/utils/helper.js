import ADD_STORY_IMG from '../assets/add-story.svg'
import NO_SEARCH_DATA_IMG from '../assets/no-search-data.svg'
import NO_FILTER_DATA_IMG from '../assets/no-filter-data.svg'
